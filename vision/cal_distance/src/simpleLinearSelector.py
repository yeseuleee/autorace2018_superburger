...
IMG_PATH = '/home/seuleee/catkin_ws/src/autorace2018_superburger/vision/cal_distance/src/0.jpg'

mtx_ls = [616.186676, 0, 325.03301, 0, 614.308494, 243.514482, 0, 0, 1] #camera matrix
dist = np.array([0.096314, -0.162566, 0.002656, 0.006255, 0]) #distortion matrix
fx_=1 #resize x 계수
fy_=1 #resize y 계수
...
if __name__=='__main__':
    ...
    mtx_ls = [616.186676, 0, 325.03301, 0, 614.308494, 243.514482, 0, 0, 1]
    for i in range(0, 3):
        for j in range(0, 3):
