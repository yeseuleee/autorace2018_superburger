...
public:
    ...
    Pos pixel_to_real(const Pos& pos){
      ...
      Pos distance( real_dr.x+  0.06 * down / ( up + down ), real_dr.y + 0.06 * right / ( left + right ) );
...
int main(int argc, char** argv){
    ...
    if(IMAGE){
      ...
      while(1){
        cout<<"!!"<<endl;
        src = imread("/home/seuleee/catkin_ws/src/autorace2018_superburger/vision/cal_distance/src/0.jpg", CV_LOAD_IMAGE_COLOR);
